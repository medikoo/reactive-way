...
var errorTpl = require('fs').readFileSync(resolve(__dirname,
	'../node_modules/webmake-middleware/error-template.js'), 'utf8');
...
module.exports = function (config/*, options*/) {
	...
	return function webmakeMiddleware(req, res, next) {
		...
		promise = webmake(config[path], options.tplsPath, function (err, src) {
